# -*- coding: utf-8 -*-
"""NFL predictive model.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18WwWFwCCm48lae1c4_aWiXGRj-X35jDH
"""
...
def get_elo():
    elo_df = pd.read_csv('/content/drive/MyDrive/nfl-elo/nfl_elo.csv')
...
comp_games_df1=comp_games_df.fillna(0)
pred_games_df1=pred_games_df.fillna(0)

comp_games_df1.shape

msk = np.random.rand(len(comp_games_df1)) < 0.8

train_df = comp_games_df1[msk]
test_df = comp_games_df1[~msk]
...
cm=confusion_matrix(np.round(y_test,0),np.round(y_pred,0))
cm
...
X_test = pred_games_df1.drop(columns = ['away_name', 'away_abbr', 'home_name', 'home_abbr', 'week','result'])
y_pred = model.predict_proba(X_test)
y_pred = y_pred[:,1]

display(y_pred,pred_games_df1)
